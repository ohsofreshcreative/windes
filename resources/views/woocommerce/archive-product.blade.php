...
<header class="woocommerce-products-header">
	...
	<h1 class="woocommerce-products-header__title page-title relative w-full md:w-1/2 mt-10 mb-10">{!! woocommerce_page_title(false) !!}</h1>
	@endif
	<div class="__bg absolute -top-20 -right-40 opacity-10 pointer-events-none">
		<img class="" src="/wp-content/uploads/2025/09/sign.svg">
	</div>
</header>
@php
